...
;==================================
	;======Switch to PL 1 Task=====
	mov dword [0x590] , 0xface
	call 0x70:0 ;== call 0x70 with RPL 0==
	jmp chanHappy
...
;==================================
	...
	iret
;==================================
; ISR for Exception type 13
;==================================
align 0x800
	mov ax,0x10
	mov ds,ax
	mov ax,0x20
	mov FS,ax				;b500 - b5ff : Current User Password (A)
	mov ax,0x18
	mov GS,ax				;b600 - b6ff : Elevated User's Password repository (B)
	mov ecx,0x0				;pointer to Current User Password 
	L1:mov ebx,[FS:ecx]
	mov edx,0x0				;pointer to Elevated  User's Password
		L2:
		mov eax,[GS:edx]
		sub eax,0x230
		cmp ebx,eax;
		jz AcessGranded
		add edx,0x4;		; Next Password
		cmp edx,0x8			; 2 password stored in Elevated  User's Password repository hence 2* 4 = 8
		jnz L2
	add ecx,0x4				; Next Password
	cmp ecx,0x8				; 2 password stored in Current User Password (A) hence 2* 4 = 8
	jnz L1
	int 3
AcessGranded:
	mov byte [0x202d],0xb2
	mov ax,0x28
	iretd
;----------------------------YOUR CODE ENDS here-----------------
...
dd 0x0058	; ldt
dd 0x0000	; io-map
align 0x100			;Address = 0xb500 ;current user’s password is stored in a read only segment(A)
dd 0xabab
dd 0xaaaa

align 0x100;       ;password hashes of the elevated users are stored in a read only segment(B) 
dd 0xaddb
dd 0xacda
...
;===================================================
dd 0xa000bfff, 0x004f9b00	;#0x08	#Code	#0
;===================================================
dd 0xb000ffff, 0x00409200	;#0x10	#Data	#0
;===================================================
dd 0xb60000ff, 0x00409000	;#0x18	#Data	#0  Elevated User's Password repository (B)
dd 0xb50000ff, 0x0040b200	;#0x20	#Data	#1  Current User Password (A)
dd 0xb70000ff, 0x00409200	;#0x28	#Data	#2  PL0 segment which the user tries to access (ES in the example)
dd 0xe3000100, 0x0040f200	;#0x30	#Data	#3
;===================================================
dd 0xc0000100, 0x00409200	;#0x38	#Stack	#0
dd 0xc1000100, 0x0040b200	;#0x40	#Stack	#1
dd 0xc2000100, 0x0040d200	;#0x48	#Stack	#2
dd 0xc3000100, 0x0040f200	;#0x50	#Stack	#3
;===================================================
dd 0xd10000ff, 0x0000e200	;#0x58	#Ldt	#3
;dd 0x00080100, 0x0000ec00	;#0x58	#Call	#3
dd 0xda680067, 0x00408900	;#0x60	#Tss	#0
;===================================================
dd 0xb0000070, 0x00408900	;#0x68	#Tss	#0
dd 0xb1000070, 0x00408900	;#0x70	#Tss	#0
dd 0xb2000070, 0x0040a900	;#0x78	#Tss	#1
dd 0xb3000070, 0x0040c900	;#0x80	#Tss	#2
dd 0xb4000070, 0x00408900	;#0x88	#Tss	#0
dd 0xdc700067, 0x0040e900	;#0x90	#Tss	#3
dd 0xdcd80067, 0x0040e900	;#0x98	#Tss	#3
dd 0xdd400067, 0x0040e900	;#0xa0	#Tss	#3
;===================================================
dd 0xa2000200, 0x0040ba00	;#0xa8	#Code	#1
dd 0xa4000200, 0x0040da00	;#0xb0	#Code	#2
dd 0xa6000200, 0x0040fa00	;#0xb8	#Code	#3
dd 0xa0000200, 0x00409e00	;#0xc0	#Code	#0
;===================================================
dd 0xc4000100, 0x00409200	;#0xc8	#Stack	#0
dd 0xc5000100, 0x0040b200	;#0xd0	#Stack	#1
dd 0xc6000100, 0x0040d200	;#0xd8	#Stack	#2
dd 0xc7000100, 0x0040b200	;#0xe0	#Data	#1
;===================================================
dd 0x00080100, 0x0000ec00	;#0xe8	#Call	#3
;dd 0xd10000ff, 0x0000e200	;#0xe8	#Ldt	#3
;===================================================
dd 0x00680000, 0x0000e500	;#0xf0	#TG	#-
;===================================================
dd 0x8e765f52, 0x2e8a9108	;#0xf8	#Rand	#-
