...
;==================================
	;======Switch to PL 1 Task=====
	mov dword [0x600] , 0xc0ffee
	call 0x80:0 ;call to PL-3 task
	jmp chanHappy
	
;==================================
; B0: To be called by Call Gate
;==================================
align 0x100	; address= 0xa100
	mov ax,0x18
	mov DS,ax
	mov dword [0x0] , 0xdeaf1b01

	retf
;==================================
; A0: To be called by Task Gate
;==================================
align 0x800	; Address = 0xa800
	mov ax,0x18
	mov DS,ax
	mov dword [0x8] , 0xdeaf2a02
	iret
;==================================
; Task - PL 3
;==================================
align 0x200; Address = 0xaa00
	mov ax,0x33
	mov DS,ax
	mov dword [0x0] , 0xdeaf3333
	;===========call to CALL GATE=========
	call 0xeb:0  ;CALL gate with descriptor 0xe8 and RPL 3
	;====Return from CALL GATE====
	mov ax,0x33
	mov DS,ax
	mov dword [0x4] , 0xbeef
	;====Call to Task Gate=============
	call 0xf3:0		;CALL Task gate descriptor 0xf0 and RPL 3 
	;====Return from Task Gate======
	mov dword [0x8] , 0xbead
	iret
...
;===================================================
dd 0xe0000100, 0x00409200	;#0x18	#Data	#0
dd 0xe1000100, 0x0040b200	;#0x20	#Data	#1
dd 0xe2000100, 0x0040d200	;#0x28	#Data	#2
...
dd 0xaa000200, 0x0040fa00	;#0xb8	#Code	#3
...
;===================================================
dd 0x00080100, 0x0000ec00	;#0xe8	#Call	#3  call gate pointing to B0
;dd 0xd10000ff, 0x0000e200	;#0xe8	#Ldt	#3
;===================================================
dd 0x00700000, 0x0000e500	;#0xf0	#TG	#-		call to A0
;===================================================
